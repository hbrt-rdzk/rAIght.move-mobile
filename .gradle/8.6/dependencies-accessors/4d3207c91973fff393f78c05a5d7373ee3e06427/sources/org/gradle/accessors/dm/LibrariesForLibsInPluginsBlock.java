...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final OkLibraryAccessors laccForOkLibraryAccessors = new OkLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>ok</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public OkLibraryAccessors getOk() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForOkLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class AndroidxNavigationLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
    ...
    public static class MediapipeLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>pose</b> with <b>com.google.mediapipe:tasks-vision</b> coordinates and
         * with version reference <b>mediapipePose</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getPose() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("mediapipe.pose");
        }
     ...
     */
    @Deprecated
    public static class OkLibraryAccessors extends SubDependencyFactory {

        public OkLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>http</b> with <b>com.squareup.okhttp3:okhttp</b> coordinates and
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>mediapipePose</b> with value <b>0.10.14</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMediapipePose() { return getVersion("mediapipePose"); }
